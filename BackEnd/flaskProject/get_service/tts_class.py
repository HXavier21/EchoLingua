...
class TTS(multiprocessing.Process):
    ...
    def run(self):
        ...
        default_wav = "D:\\code\\SoftwareEngineering\\TTS\\models\\Asta\\平静说话-你们经过的收容舱段收藏着诸多「奇物」和「遗器」，是最核心的研究场所。.wav"
        default_text = '你们经过的收容舱段收藏着诸多「奇物」和「遗器」，是最核心的研究场所。'
        default_language = 'zh'
        ...
        gpt_path = "D:\\code\\SoftwareEngineering\\TTS\\models\\Asta\\Asta-e10.ckpt"
        sovits_path = "D:\\code\\SoftwareEngineering\\TTS\\models\\Asta\\Asta_e25_s925.pth"
        ...
        def get_tts_wav(*, refer_wav_path, prompt_text, prompt_language="zh", text="", text_language="zh", top_k=5,
                        top_p=1,
        ...
        with open("models_information.json", "r") as f:
            models_information = json.load(f)
            model_information = models_information[self.name]
        ...
        async def use_tts(text, text_language):
            wav = handle(
                refer_wav_path,
                prompt_text,
                prompt_language,
